    ...
    <div style={{display:'flex',flexDirection:'column',height:'100%'}}>
      <div className="dash-header">
        <div className="dh-left">
          <div className="dh-icon" style={{background:'#f5f3ff',color:'#7c3aed'}}><BarChart3 size={20}/></div>
        ...
        <div className="dh-actions">
          ...
          <button className="btn btn-ghost" onClick={()=>{setLoading(true);api.getAnalytics().then(d=>{setData(d);setLoading(false)}).catch(()=>setLoading(false))}}><RefreshCw size={14}/> Refresh</button>
        </div>
      </div>
      <div className="page-body">
        ...
        <div style={{fontSize:12,fontWeight:700,textTransform:'uppercase',letterSpacing:1,color:'#94a3b8'}}>Public Bus — In-Service Training</div>
        ...
        <div style={{fontSize:12,fontWeight:700,textTransform:'uppercase',letterSpacing:1,color:'#94a3b8'}}>Public Bus — Pre-Service Training</div>
        <div className="chart-grid c2">
        ...
        <div style={{fontSize:12,fontWeight:700,textTransform:'uppercase',letterSpacing:1,color:'#94a3b8'}}>Recruitment Pipeline</div>
        ...
        <div style={{fontSize:12,fontWeight:700,textTransform:'uppercase',letterSpacing:1,color:'#94a3b8'}}>School Bus Training</div>
        <div className="chart-grid c2">
