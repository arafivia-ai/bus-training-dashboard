    ...
    <div className="space-y-5">
      ...
      {tab==='Records' && (
        <div className="card">
          ...
          <DataTable columns={columns} rows={filtered} loading={loading} page={page} total={total} limit={LIMIT} onPage={p=>loadRecords(p)} emptyIcon="🚕" emptyText="No taxi records found"/>
        </div>
      )}
    </div>
  )
