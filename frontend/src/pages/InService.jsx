...
import { Upload, Bus } from 'lucide-react'
    ...
    <div className="space-y-5">
      ...
      {tab==='Overview' && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <KPICard label="Active Depots"   value={Object.keys(analytics?.byDepot||{}).length}    icon={Bus} color="amber"  sub="With records"/>
      ...
      {tab==='Analysis' && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <BarChartBox   title="Top 10 Nationalities" sub="Most represented"   data={natData}  height={260} horiz={true}/>
          </div>
      ...
      {tab==='Records' && (
        <div className="card">
          ...
          <DataTable columns={columns} rows={filtered} loading={loading} page={page} total={total} limit={LIMIT} onPage={p=>loadRecords(p)} emptyIcon="🚌" emptyText="No training records found"/>
        </div>
      )}
    </div>
  )
